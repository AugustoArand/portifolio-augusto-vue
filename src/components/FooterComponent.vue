  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <ul class="contact-list">
            <li>📧 <a href="mailto:augusto@example.com">augusto@example.com</a></li>
      ...
      <div class="footer-bottom">
        <p>&copy; 2024 Augusto Arand. Todos os direitos reservados.</p>
        <p>Desenvolvido com ❤️ usando Vue.js</p>
      </div>
    </div>
  </footer>
</template>
